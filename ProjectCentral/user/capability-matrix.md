...
| [How?](central.html#whole/how) | [8 capabilities](#field-q2-S) | Unassessed | Unassessed | Unassessed | Unassessed | Unassessed |
...
[machine recovery](#cap-central-machine-recovery) · [projectcentral lifecycle](#cap-central-projectcentral-lifecycle) · [source editing](#cap-central-source-editing) · [now](#cap-central-now) · [day rollover](#cap-central-day-rollover) · [agent profiles](#cap-central-agent-profiles) · [control proposals](#cap-central-control-proposals) · [guided ground authoring](#cap-central-guided-ground-authoring)
