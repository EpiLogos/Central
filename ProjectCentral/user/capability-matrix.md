...
| `central.self.ensure` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `central.self.ex.relate` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `central.self.inspect` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `central.self.resolve` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `central.self.source.create` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `central.self.tier.relate` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `central.self.ux.relate` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `central.system` | [cap.central.system](#cap-central-system) |
...
| `machine.oi-suite-policy` | [cap.central.development-field-source](#cap-central-development-field-source) |
...
| `projectcentral.self.ensure` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `projectcentral.self.ex.relate` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `projectcentral.self.inspect` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `projectcentral.self.resolve` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `projectcentral.self.retain-tier` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `projectcentral.self.source.create` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `projectcentral.self.tier.relate` | [cap.central.development-field-source](#cap-central-development-field-source) |
| `projectcentral.self.ux.relate` | [cap.central.development-field-source](#cap-central-development-field-source) |
...
| [Disclose Central's own settings](#cap-central-system) | A person or an Agent engaging Central as an O:I suite owner needs one reading of its actual state — authored, resolved, observed and staged — before deciding what to do next. |
...
<a id="cap-central-system"></a>
### Disclose Central's own settings

`cap.central.system` · #capability #central

A person or an Agent engaging Central as an O:I suite owner needs one reading of its actual state — what is authored, what Central actually resolved, what is presently observed, and what stands proposed — before deciding what to do next, without Central turning into a second settings database. The read-only `central.system` Action, reached as `ctrl system --json`, composes Central's own `oi.product-settings-disclosure/v2` descriptor across eight sections (ground, self-description, machine intent, skills, privacy, proposals, accepted source mutation, actions), each split into declared/effective/active/staged axes with provenance and a drift flag.

Callers receive one digest-stamped document — a locally implemented, FIPS-180-4-verified SHA-256 over the descriptor with every `*_unix_ms` field zeroed, so repeated readings of unchanged state hash identically — that keeps authored intent, resolved state, live observation and staged proposal distinguishable. Owner availability is derived from the existing doctor probe rather than hardcoded.

**Source:** [docs/CENTRAL-SYSTEM-SPEC.md](../../docs/CENTRAL-SYSTEM-SPEC.md).

**Implementation:** [ctrl/src/system_disclosure.rs](../../ctrl/src/system_disclosure.rs); [ctrl/src/cli.rs](../../ctrl/src/cli.rs); [ctrl/src/lib.rs](../../ctrl/src/lib.rs). **Test definitions:** [ctrl/src/system_disclosure.rs](../../ctrl/src/system_disclosure.rs).

**Verification limit:** Native suite verified on this branch (cargo test -p ctrl 339 passed); `ctrl action list --json` and `ctrl system --json` were run directly against this build and confirmed a well-formed descriptor. Desktop/O:I surface acceptance is not established here.
...
<a id="cap-central-development-field-source"></a>

### Development Field source

Central exposes the root and Project self-description aperture, stable document-tier relations, UX/EX source identity and opaque machine O:I suite-policy intent through canonical source refs and revisions. Human source authority, Agent Wiki knowledge, observed state and generated material remain distinct; retained native source does not need to move merely to participate.

[Source contract](../../docs/DEVELOPMENT-FIELD-SOURCE.md) · [Control source law](../../docs/CONTROL-CONTENT-PROTOCOL.md) · standing: agent-inference.
...
cap.central.action-discovery,capability,,,,[],A person or agent needs to discover what this installed Central can actually do before choosing a command.,ctrl capabilities and action.list expose the native Action registry; the guided picker helps select an operation and its inputs.,"Callers receive named operations, input definitions, mutation classes and capability requirements. The same canonical operation can be selected through different surfaces.",source-inspected; Source and test definitions inspected; these tests were not executed in this documentation pass. Desktop and owner-machine acceptance is not established here.,agent-inference,../github-recovery-mirror/mirror/Central/issues/3.json;../github-recovery-mirror/mirror/Central/issues/7.json;../github-recovery-mirror/mirror/Central/issues/114.json,ctrl/src/action.rs;ctrl/src/picker.rs;ctrl/src/cli.rs;ctrl/src/result.rs,ctrl/tests/cli_doorway.rs;ctrl/tests/picker.rs,central.html#q3/interaction,,,"{""basis"": ""Source-recovered capability account; original verification limits retained in Markdown."", ""converted_from_sha256"": ""c305f22c02710fb8e246eac3ccd50651fa12f22d20da8c42c2c126e60530ec66"", ""cli_commands"": [""action.list""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The listed native Action identities are invocable through ctrl action run and discoverable through ctrl action list.""}, ""maintenance"": {""updated_at"": ""2026-09-11"", ""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/Central/issues/3.json"", ""../github-recovery-mirror/mirror/Central/issues/7.json"", ""../github-recovery-mirror/mirror/Central/issues/114.json"", ""central:74258b3"", ""central:d357e94"", ""EpiLogos/Central#127 (W10 V2: agent-set/world persistence Actions + attribution seam; cli/now/agent-profile carriers moved — code bases re-reviewed at this revision)"", ""reconcile:central-pr-132"", ""cradle:Central:w2-w4:PR-133"", ""EpiLogos/Central#148"", ""EpiLogos/Central#149""], ""code_basis"": {""ctrl/src/action.rs"": ""8956891ff55e96514266ca3ad00dbf80a0902f37e0d5a1fe18dadfe59cb6ca1b"", ""ctrl/src/picker.rs"": ""b1c04622a2118b28763d9e9c5a747a8b2523d943a741ebbcf868ec5686af8665"", ""ctrl/src/cli.rs"": ""3c972c96e911eb2269272a2ca0edb27a824552ba4e902a3cb91cce11fac67159"", ""ctrl/src/result.rs"": ""38dfe29bf586fe3a62a5d3b4fbb8df1c5e03954053d32f05a61d775417d19d6f""}}, ""last_reconciled_at"": ""2026-09-11T03:25:32.748696+00:00""}",
...
cap.central.source-change,capability,,,,[],People need to keep using ordinary editors while later sessions discover relevant source changes.,Project and Control reconciliation observes content revisions; horizon reads expose ordered changes since a consumer cursor and recover offline edits.,"Consumers receive source identities, revisions and retained standing without reading every payload. The horizon records change; interpretation and follow-up belong to its consumers.",source-inspected; Selected native suites passed 2026-09-06: source_change_horizon. Other referenced tests were not rerun; physical desktop and owner-machine effects remain outside this selection.,agent-inference,../github-recovery-mirror/mirror/Central/issues/89.json,ctrl/src/source_horizon.rs,ctrl/tests/source_change_horizon.rs;ctrl/tests/source_change_authority_override.rs,central.html#q3/contracts,,,"{""basis"": ""Source-recovered capability account; original verification limits retained in Markdown."", ""cli_commands"": [""projectcentral.change.ack"", ""projectcentral.change.horizon"", ""projectcentral.change.reconcile""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The listed native Action identities are invocable through ctrl action run and discoverable through ctrl action list.""}, ""code_basis"": {""ctrl/src/source_horizon.rs"": ""0b8f7d34f204ec336a671c91f4acfb0dae3b1a3e5bc5d9e7f4735d6a44687d99""}, ""converted_from_sha256"": ""c305f22c02710fb8e246eac3ccd50651fa12f22d20da8c42c2c126e60530ec66"", ""last_reconciled_at"": ""2026-09-10T00:16:24.167668+00:00"", ""maintenance"": {""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/Central/issues/89.json"", ""EpiLogos/Central#126 (W10 V1: central.pasu/v1 identity grammar; world-map/source-change/agent-profile carriers moved — code bases re-reviewed at this revision)"", ""reconcile:central-pr-132"", ""cradle:Central:w2-w4:PR-133"", ""EpiLogos/Central#134 (Flows belong to a register; Central root is one)"", ""EpiLogos/Central#139""], ""code_basis"": {""ctrl/src/source_horizon.rs"": ""0b8f7d34f204ec336a671c91f4acfb0dae3b1a3e5bc5d9e7f4735d6a44687d99""}, ""updated_at"": ""2026-09-10""}}",
...
cap.central.now,capability,,,,[],"Current scratch, questions and handoffs need to remain available after a chat ends.","projectcentral.now.init and inspect establish/read the temporal field; now.return and update record attributed questions, notes and handoffs with lifecycle and external references.","The next session can recover human scratch and bounded agent returns from files, including open work and supporting evidence references.",source-inspected; Selected native suites passed 2026-09-06: projectcentral_now. Other referenced tests were not rerun; physical desktop and owner-machine effects remain outside this selection.,agent-inference,../github-recovery-mirror/mirror/Central/issues/74.json,ctrl/src/projectcentral_now.rs,ctrl/tests/projectcentral_now.rs;ctrl/tests/projectcentral_now_portable_real.rs,central.html#q2/resume,,,"{""basis"": ""Source-recovered capability account; original verification limits retained in Markdown."", ""cli_commands"": [""projectcentral.now.init"", ""projectcentral.now.inspect"", ""projectcentral.now.return"", ""projectcentral.now.update""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The listed native Action identities are invocable through ctrl action run and discoverable through ctrl action list.""}, ""code_basis"": {""ctrl/src/projectcentral_now.rs"": ""1945e79ed845aab5c4db1f83df8cf37eb270a5941494ff3c42accc65618e6098""}, ""converted_from_sha256"": ""c305f22c02710fb8e246eac3ccd50651fa12f22d20da8c42c2c126e60530ec66"", ""last_reconciled_at"": ""2026-09-10T00:16:24.167668+00:00"", ""maintenance"": {""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/Central/issues/74.json"", ""EpiLogos/Central#127 (W10 V2: agent-set/world persistence Actions + attribution seam; cli/now/agent-profile carriers moved — code bases re-reviewed at this revision)"", ""reconcile:central-pr-132"", ""EpiLogos/Central#134 (Flows belong to a register; Central root is one)"", ""EpiLogos/Central#139""], ""code_basis"": {""ctrl/src/projectcentral_now.rs"": ""1945e79ed845aab5c4db1f83df8cf37eb270a5941494ff3c42accc65618e6098""}, ""updated_at"": ""2026-09-10""}}",
cap.central.day-rollover,capability,,,,[],A person needs a dated account of work while keeping unfinished material available and promoting useful findings deliberately.,now.rollover snapshots the chosen local civil day and carries live material; now.promote records the move from temporal material toward a durable owner.,"DAY records preserve source state and carry-forward decisions. Eligible completed clutter can clear; protected material remains. Agent promotion returns material to wiki ownership, where semantic integration is a later operation.",source-inspected; Selected native suites passed 2026-09-06: projectcentral_now. Other referenced tests were not rerun; physical desktop and owner-machine effects remain outside this selection.,agent-inference,../github-recovery-mirror/mirror/Central/issues/74.json;../github-recovery-mirror/mirror/Central/issues/93.json,ctrl/src/projectcentral_now.rs,ctrl/tests/projectcentral_now.rs;ctrl/tests/projectcentral_now_portable_real.rs,central.html#q2/resume,,,"{""basis"": ""Source-recovered capability account; original verification limits retained in Markdown."", ""cli_commands"": [""projectcentral.now.promote"", ""projectcentral.now.rollover""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The listed native Action identities are invocable through ctrl action run and discoverable through ctrl action list.""}, ""code_basis"": {""ctrl/src/projectcentral_now.rs"": ""1945e79ed845aab5c4db1f83df8cf37eb270a5941494ff3c42accc65618e6098""}, ""converted_from_sha256"": ""c305f22c02710fb8e246eac3ccd50651fa12f22d20da8c42c2c126e60530ec66"", ""last_reconciled_at"": ""2026-09-10T00:16:24.167668+00:00"", ""maintenance"": {""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/Central/issues/74.json"", ""../github-recovery-mirror/mirror/Central/issues/93.json"", ""EpiLogos/Central#127 (W10 V2: agent-set/world persistence Actions + attribution seam; cli/now/agent-profile carriers moved — code bases re-reviewed at this revision)"", ""reconcile:central-pr-132"", ""EpiLogos/Central#134 (Flows belong to a register; Central root is one)"", ""EpiLogos/Central#139""], ""code_basis"": {""ctrl/src/projectcentral_now.rs"": ""1945e79ed845aab5c4db1f83df8cf37eb270a5941494ff3c42accc65618e6098""}, ""updated_at"": ""2026-09-10""}}",
cap.central.flow,capability,,,,[],"A developing idea needs continuity across sessions, days and changes of filename.",Flow create/adopt/read/write/rename/lifecycle/history operations maintain a stable FlowRef and revision-safe ordinary-file content.,"One thread retains identity while active, dormant or closed; renaming preserves continuity and DAY snapshots retain earlier states. Desktop conversation and knowledge interpretation consume this source lifecycle.",source-inspected; Selected native suites passed 2026-09-06: projectcentral_flow. Other referenced tests were not rerun; physical desktop and owner-machine effects remain outside this selection.,agent-inference,../github-recovery-mirror/mirror/Central/issues/93.json,ctrl/src/projectcentral_flow.rs,ctrl/tests/projectcentral_flow.rs,central.html#q2/develop-thought,,,"{""basis"": ""Source-recovered capability account; original verification limits retained in Markdown."", ""cli_commands"": [""projectcentral.flow.adopt"", ""projectcentral.flow.create"", ""projectcentral.flow.history"", ""projectcentral.flow.inspect"", ""projectcentral.flow.lifecycle"", ""projectcentral.flow.list"", ""projectcentral.flow.read"", ""projectcentral.flow.rename"", ""projectcentral.flow.write"", ""projectcentral.flow.now""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The listed native Action identities are invocable through ctrl action run and discoverable through ctrl action list.""}, ""code_basis"": {""ctrl/src/projectcentral_flow.rs"": ""ed3db1c6d0025da517db7bb5c14811e554e21009faf8b9dfba73709c64a2cda9""}, ""converted_from_sha256"": ""c305f22c02710fb8e246eac3ccd50651fa12f22d20da8c42c2c126e60530ec66"", ""last_reconciled_at"": ""2026-09-10T00:16:24.167668+00:00"", ""maintenance"": {""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/Central/issues/93.json"", ""reconcile:central-pr-132"", ""cradle:Central:w2-w4:PR-133"", ""EpiLogos/Central#134 (Flows belong to a register; Central root is one)"", ""EpiLogos/Central#139""], ""code_basis"": {""ctrl/src/projectcentral_flow.rs"": ""ed3db1c6d0025da517db7bb5c14811e554e21009faf8b9dfba73709c64a2cda9""}, ""updated_at"": ""2026-09-10""}}",
...
cap.central.development-field-source,capability,,,,[],"A World or Project needs its durable self-description, intended experience and human experiential return to be addressable without collapsing authored source into Wiki knowledge, observation or generated material.","Central resolves root/Project self apertures, stable 0..5 tier relations, UX/EX source refs and opaque machine O:I suite-policy intent through canonical SourceRef, revision and standing contracts.","Consumers can address self-description and retained native sources without reconstructing paths; EX remains human-attributable, and installed-suite/material facts stay with their native owners.",implemented; S1 native source/read/Action behavior is covered by hosted Rust and Action-surface tests; physical H/EX acceptance remains external.,agent-inference,docs/DEVELOPMENT-FIELD-SOURCE.md;docs/CONTROL-CONTENT-PROTOCOL.md;docs/MACHINE-WORKCELL-RELATION.md,ctrl/src/development_field.rs,ctrl/src/development_field.rs;ctrl/tests/foundation.rs;surfaces/macos-host/tests/host_surface.rs,central.html#q1/ground,,,"{""basis"": ""Development Field S1 native source surface; capability maintenance for #136, not bulk source migration."", ""cli_commands"": [""central.self.ensure"", ""central.self.ex.relate"", ""central.self.inspect"", ""central.self.resolve"", ""central.self.source.create"", ""central.self.tier.relate"", ""central.self.ux.relate"", ""machine.oi-suite-policy"", ""projectcentral.self.ensure"", ""projectcentral.self.ex.relate"", ""projectcentral.self.inspect"", ""projectcentral.self.resolve"", ""projectcentral.self.retain-tier"", ""projectcentral.self.source.create"", ""projectcentral.self.tier.relate"", ""projectcentral.self.ux.relate""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The S1 source-field Actions are native Central owner operations, invocable through ctrl action run and discoverable through ctrl action list.""}, ""maintenance"": {""updated_at"": ""2026-09-10"", ""change_refs"": [""EpiLogos/Central#136"", ""EpiLogos/Central#145""], ""code_basis"": {""ctrl/src/development_field.rs"": ""51fdae30de3a4940aefcfd3c0f07e7d162a35e1c700e98b4f823fab33b85ae29""}}, ""last_reconciled_at"": ""2026-09-10T01:42:55.304963+00:00""}",
...
cap.central.pasu-identity,capability,,,,[],A person needs their human identity grounded as a versioned bounded-entity subject the whole toolchain can name without a second registry.,central.pasu/v1 parses and validates nara/agent/agent-set refs; the nara identity-source manifest anchors the authored Control/user/identity folder; ground relations carry the subject ref; central.world exposes identity state with per-file content revisions.,"Identity ownership stays in authored Central ground while Factory, Actuation and AIKit reference one stable subject; identity-source edits are observable as content-revision changes.","source-inspected; exercised by unit, integration and live central.world runs during the authoring session.",agent-inference,../github-recovery-mirror/mirror/Central/issues/108.json;../github-recovery-mirror/mirror/Central/issues/117.json,ctrl/src/pasu.rs;ctrl/src/lib.rs,ctrl/tests/world_map.rs,central.html#q1/entry,,,"{""basis"": ""Owner-directed identity carrier (W10 V1); original verification limits retained."", ""cli_commands"": [], ""cli_exposure"": {""kind"": ""library"", ""reason"": ""The grammar and identity read-model surface through central.world and the ground-relations read path; the capability owns no CLI command of its own.""}, ""code_basis"": {""ctrl/src/lib.rs"": ""e4c9580a563ea19197453930c8770967338f362999d93b6405b19eb3afd47393""}, ""last_reconciled_at"": ""2026-09-11T03:25:32.748696+00:00"", ""maintenance"": {""change_refs"": [""EpiLogos/Central#126"", ""zcode-session-2026-09-07"", ""EpiLogos/Central#126 (W10 V1: central.pasu/v1 identity grammar; world-map/source-change/agent-profile carriers moved — code bases re-reviewed at this revision)"", ""EpiLogos/Central#127 (W10 V2: agent-set/world persistence Actions + attribution seam; cli/now/agent-profile carriers moved — code bases re-reviewed at this revision)"", ""reconcile:central-pr-132"", ""cradle:Central:w2-w4:PR-133"", ""EpiLogos/Central#134 (Flows belong to a register; Central root is one)"", ""EpiLogos/Central#139"", ""EpiLogos/Central#142 (agent-set orchestration + world default set; corrections carry their own provenance — code bases re-reviewed at this revision)"", ""EpiLogos/Central#142"", ""EpiLogos/Central#136"", ""EpiLogos/Central#145"", ""EpiLogos/Central#149""], ""code_basis"": {""ctrl/src/lib.rs"": ""dfe2880510cb08eef151fc3a431585b0b810534530199db854687feb32522a73"", ""ctrl/src/pasu.rs"": ""7e28f75ab14d6404d638a5c1a8bebacae3115a9660638dc7c0ab883fc5b3f606""}, ""updated_at"": ""2026-09-11""}}",
cap.central.bounded-relations,capability,,,,[],A person needs durable authored AgentSets and world relations so composed participation and source propagation survive sessions and stay revisable.,central.agent-set.* and central.world-relations.* persist and resolve central.agent-set/v1 and central.world-relations/v1 records under compare-and-swap revisions; central.agent-set.resolve partitions authored membership against declared availability and rejects cycles; central.world.effective-sources resolves ancestry propagation with per-hop provenance.,Composed agent participation and world source propagation become real operations on real files; authored records never rewrite on availability changes and effective relations stay attributable per hop.,"source-inspected; exercised by unit, integration and live Action runs during the authoring session.",agent-inference,../github-recovery-mirror/mirror/Central/issues/108.json,ctrl/src/agent_set_store.rs;ctrl/src/agent_set_actions.rs;ctrl/src/lib.rs;ctrl/src/world.rs,ctrl/tests/foundation.rs,central.html#q3/interaction,,,"{""basis"": ""Owner-directed persistence slice (W10 V2); the domain model's owned Actions."", ""cli_commands"": [""central.agent-set.save"", ""central.agent-set.list"", ""central.agent-set.read"", ""central.agent-set.remove"", ""central.agent-set.resolve"", ""central.world-relations.save"", ""central.world-relations.list"", ""central.world-relations.read"", ""central.world-relations.remove"", ""central.world.effective-sources""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The listed native Action identities are invocable through ctrl action run and discoverable through ctrl action list.""}, ""code_basis"": {""ctrl/src/lib.rs"": ""e4c9580a563ea19197453930c8770967338f362999d93b6405b19eb3afd47393""}, ""last_reconciled_at"": ""2026-09-11T03:25:32.748696+00:00"", ""maintenance"": {""change_refs"": [""EpiLogos/Central#127"", ""zcode-session-2026-09-07"", ""EpiLogos/Central#127 (W10 V2: agent-set/world persistence Actions + attribution seam; cli/now/agent-profile carriers moved — code bases re-reviewed at this revision)"", ""reconcile:central-pr-132"", ""cradle:Central:w2-w4:PR-133"", ""EpiLogos/Central#134 (Flows belong to a register; Central root is one)"", ""EpiLogos/Central#139"", ""EpiLogos/Central#142 (agent-set orchestration + world default set; corrections carry their own provenance — code bases re-reviewed at this revision)"", ""EpiLogos/Central#142"", ""EpiLogos/Central#136"", ""EpiLogos/Central#145"", ""EpiLogos/Central#148"", ""EpiLogos/Central#149""], ""code_basis"": {""ctrl/src/agent_set_actions.rs"": ""10b49eec868a8c9f64e924a04ade79846234dac0dad2a7c513902868e54d372f"", ""ctrl/src/agent_set_store.rs"": ""6fd0a8c32e9d3033948fccbc83d6d25df1413391650de1685263423b911275e0"", ""ctrl/src/lib.rs"": ""dfe2880510cb08eef151fc3a431585b0b810534530199db854687feb32522a73"", ""ctrl/src/world.rs"": ""cc27a278383c2bb356f187a06f137623bd8a9025c4c538071cc1de1534c647c2""}, ""updated_at"": ""2026-09-11""}}",
...
cap.central.system,capability,,,,[],"A person or an Agent engaging Central as an O:I suite owner needs one reading of its actual state — what is authored, what Central actually resolved, what is presently observed, and what stands proposed awaiting a human decision — before deciding what to do next, without Central turning into a second settings database or a duplicate Action catalogue.","The read-only central.system Action, reached as `ctrl system --json` (or `ctrl action run central.system --json`), composes Central's own oi.product-settings-disclosure/v2 descriptor across eight sections — ground/register binding, project registers, self-description, machine intent, skills standing, privacy/retrieval markers, pending source-return proposals, accepted source relations, and the native Action field. Each section splits into declared (authored), effective (resolved), active (observed), and staged (awaiting human acceptance) axes with provenance and a drift flag, plus the concrete Action its next change would run through; owner availability (available/degraded/unavailable) is derived from the existing doctor probe rather than hardcoded.","Callers receive one digest-stamped document — a locally implemented, FIPS-180-4-verified SHA-256 over the descriptor with every `*_unix_ms` field zeroed, so repeated readings of unchanged state hash identically — that keeps authored intent, resolved state, live observation and staged proposal distinguishable. `ctrl system --json` emits the bare descriptor on stdout as the O:I composition kernel's mount-seam payload, while the human-readable rendering instead summarises availability and per-section setting counts.","source-inspected; native suite verified on this branch (cargo test -p ctrl 339 passed), including the sha256 FIPS 180-4 vectors, zero_timestamps recursion and doctor-probe-derived availability unit tests inside system_disclosure.rs; `ctrl action list --json` and `ctrl system --json` were run directly against this build and confirmed central.system is discoverable and returns a well-formed descriptor. Desktop/O:I surface acceptance is not established here.",agent-inference,docs/CENTRAL-SYSTEM-SPEC.md,ctrl/src/system_disclosure.rs;ctrl/src/cli.rs;ctrl/src/lib.rs,ctrl/src/system_disclosure.rs,central.html#q3/interaction,,,"{""basis"": ""Wave 5 settings-disclosure capability; central.system composes Central's own oi.product-settings-disclosure/v2 reading as one of six O:I product repos getting the same kind of disclosure surface in this cross-repo initiative."", ""cli_commands"": [""central.system""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""central.system is discoverable through ctrl action list and invoked directly as ctrl system --json (or ctrl action run central.system --json); the bare descriptor is emitted on stdout rather than the ActionResult envelope because it is itself the O:I composition kernel's mount-seam payload.""}, ""maintenance"": {""updated_at"": ""2026-09-11"", ""change_refs"": [""EpiLogos/Central#149""], ""code_basis"": {""ctrl/src/system_disclosure.rs"": ""1d56250538cf5d640e661d70e6bc8d008adf018aa27ade1168d8aea28821f663"", ""ctrl/src/cli.rs"": ""3c972c96e911eb2269272a2ca0edb27a824552ba4e902a3cb91cce11fac67159"", ""ctrl/src/lib.rs"": ""dfe2880510cb08eef151fc3a431585b0b810534530199db854687feb32522a73""}}, ""last_reconciled_at"": ""2026-09-11T03:31:18.214409+00:00""}",
```
